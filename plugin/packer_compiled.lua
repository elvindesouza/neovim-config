...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "nvim-autopairs", "cmp-nvim-lsp-signature-help", "cmp-cmdline", "cmp-nvim-lua", "cmp-under-comparator", "cmp-buffer", "cmp-nvim-lsp-document-symbol", "cmp-nvim-lsp", "cmp-path" },
