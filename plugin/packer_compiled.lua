...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-under-comparator", "cmp-buffer", "cmp-nvim-lsp-document-symbol" },
